...
internal class FactProposalEntity(
    ...
    @Enumerated(EnumType.STRING) @Column(name = "suggested_evidence_level", nullable = false, length = 64) val suggestedEvidenceLevel: EvidenceLevel,
    @Enumerated(EnumType.STRING) @Column(name = "reviewed_evidence_level", length = 64) var reviewedEvidenceLevel: EvidenceLevel? = null,
